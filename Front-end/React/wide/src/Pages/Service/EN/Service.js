    ...
    return (
        <>
            <div className={CSS.landing}>
                <div>
                    <h1>Web Design And <br /> Development Company KSA</h1>
                    <p>Work with one of the top-rated web development companies in KSA to have the best design, user-friendly website, relevant content, and buzz in social media.</p>
                    <button className={CSS.landingFreeQuote}>Free Quote</button>
                </div>
            ...
            <div className={CSS.offerService}>
                <div>
                    <h2 style={{paddingBlock: "50px"}}>We offer you this service</h2>
            ...
            <div className={CSS.packages}>
                ...
                <div className={CSS.packagesContent}>
                    ...
                    <div className={CSS.packagesPrimary}>
                        <h4>The Silver plan</h4>
                        <h1>300 $</h1>
                        <p>Lorem ipsum dolor sit amet, Est quia esse id laboriosam .</p>
                        <h5>What’s Inside</h5>
