    ...
    return (
        <>
            <div className={CSS.landing}>
                <div>
                    <img src={wide} style= {{paddingBottom: "20px", paddingTop: "60px"}} />
                    <h1 style={{fontWeight: "50"}}>Marketing Agency <br />in Riyadh, KSA</h1>
                ...
                <div className={CSS.whoWeAreBottom}>
                    <div className={CSS.whoWeAreIcons}>
                        <div>
                            ...
                            <p>We have every skill to create and execute successful online marketing campaigns.</p>
                        </div>
                        <div style={{paddingInline: "50px"}}>
                            <img src={time} />
                            <h4>Up to date with creative ideas</h4>
                            <p>Never-ending creativity of our professionals combined with the latest marketing tactics.</p>
                        </div>
                        <div>
                            <img src={scale} style={{paddingTop: "10px"}} />
                            <h4>Deliver amazing services</h4>
                            <p>Online marketing services tailored to your business & delivered on time</p>
                        </div>
                    </div>
            ...
            <a href="">
                <img src={learnMoreDark} className={CSS.whoWeAreMore} />
            </a>
            <div className={CSS.ourServices}>
                <h1>OUR SERVICES</h1>
                <p style={{fontSize: "25px", paddingBottom: "20px"}}>What We Offer To Our Costumers</p>
            ...
            <div className={CSS.questions}>
                ...
                <div className={CSS.questionsContainer}>
                    <div className={CSS.questionsArea}>
                        <div>
