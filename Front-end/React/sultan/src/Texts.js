const texts = {
    ar: {
        ...
        send: 'إرسال',
        cv: 'السيرة الذاتية',
        address: 'العنوان: المملكة العربية السعودية - مدينة الرياض - حي العليا شارع التخصصي',
        sultanEmail: 'sultan@althaaly.com',
        sultanTelephone: '114623362 966+',
        telephone: 'الهاتف: ',
        email2: 'الإيميل: ',
        cvContent: '',
    ...
    en: {
        ...
        send: 'Send',
        cv: 'CV',
        address: 'Address: Saudi arabia - Riyadh - Al Olya Al Takhassousi',
        sultanEmail: 'sultan@althaaly.com',
        sultanTelephone: '+966 114623362',
        telephone: 'Telephone:',
        email2: 'Email: ',
        cvContent: '',
        rights: 'All Rights are Reserved © 2022',
    },
}
